...
export function SparamsPage({ navCollapsed, toggleNav, fileData, setFileData }: SparamsPageProps) {
    ...
    return (
        ...
        >
            ...
            <AppShell.Main>
                <SparamGraph navCollapsed={navCollapsed} fileData={fileData} setFileData={setFileData} sparams={sparams} setSparams={setSparams}/>
            </AppShell.Main>
