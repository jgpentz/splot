...
async def process_sparams(complexDataObjs: List[Dict[str, Complex]]):
    processed_data = {}
    ...
    for obj in complexDataObjs:
        ...
        # -------------------
        # Read the s params, convert complex voltage to dB, replacing nan and
        # inf/-inf, then store in dict
        s = v2db(new_xr)
